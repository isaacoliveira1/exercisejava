...
public class RemedioAct {
	public static void main(String[] args) {
		Remedio r = new Remedio("Omeprazol", "Genérico", 2, 8);
		...
		r2.setnome("Dipirona");
		r2.settipo("Alopático");
		r2.setdose(8);
		r2.setperiodicidade(4);
		
		System.out.println("Nome do Remédio: "+ r.getnome());
		System.out.println("Tipo de Remédio: " + r.gettipo());
		System.out.println("Dose: " + r.getdose());
		System.out.println("Periodicidade: " + r.getperiodicidade());
		System.out.println();
		System.out.println("Nome do Remédio: "+ r1.getnome());
		System.out.println("Tipo de Remédio: " + r1.gettipo());
		System.out.println("Dose: " + r1.getdose());
		System.out.println("Periodicidade: " + r1.getperiodicidade());
		System.out.println();
		System.out.println("Nome do Remédio: "+ r2.getnome());
		System.out.println("Tipo de Remédio: " + r2.gettipo());
